  ...
  return (
    <Container sx={{ padding: "0 16px" }}>
      ...
      >
        ...
        <Box class="image_container" sx={{ margin: "80px 0" }}>
          <img className="float" src="https://i.ibb.co/XS4qTQZ/right.png" />
        </Box>
      </Container>
      <Box
        component={motion.div}
            ...
            <Box className="embla__container">
              <Box className="embla__slide">
                ...
                >
                  ...
                  >
                    <Typography fontSize=".2rem">制作中</Typography>
                  </Box>
                </Box>
                <Typography
                  fontFamily="Noto Sans JP"
              ...
              <Box className="embla__slide">
                ...
                >
                  ...
                  >
                    <Typography fontSize=".2rem">準備中</Typography>
                  </Box>
                </Box>
                <Typography
                  fontFamily="Noto Sans JP"
